...
const GROWTH_TIERS: GrowthTier[] = [
  ...
  },
  {
    ...
    checkpoints: [
      ...
      "Systeme qui tourne sans toi (automatisation)",
      "Equipe de closers/setters",
      "Multiple offres/produits",
      "Communaute engagee",
    ],
    nextActions: [
      "Developpe un programme de formation",
      "Cree une communaute payante",
      "Explore de nouveaux marches",
    ],
  },
];
