      ...
      <div className={cn("max-w-xl mx-auto py-8", className)}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              SMS de suivi post-inscription optimisés pour la conversion
            </CardDescription>
          </CardHeader>
    ...
    <div className={cn("space-y-4", className)}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <CopyExportBar
            copyContent={messages
              .map(
                (s: { sms_number: number; body: string; delay: string }) =>
                  `SMS ${s.sms_number} (${s.delay})\n${s.body}`,
              )
              .join("\n\n---\n\n")}
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant={
                          sms.character_count <= 160 ? "default" : "yellow"
                        }
                        className="text-xs"
                      >
