...
export function FolderCard({
  ...
  return (
    <div className="group relative rounded-2xl bg-bg-secondary border border-border-default p-4 transition-all duration-150 hover:border-border-hover hover:shadow-lg hover:shadow-accent/5 cursor-pointer">
