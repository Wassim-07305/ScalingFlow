...
export function FunnelBuilder({ className, initialData }: FunnelBuilderProps) {
  ...
  if (loading) {
    return (
      <AILoading
        variant="immersive"
        text="Création de ton funnel de conversion"
        className={className}
      />
    );
  }
      ...
      <div className={cn("space-y-6", className)}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              L&apos;IA va créer le copywriting complet pour tes 3 pages de
              funnel
            </CardDescription>
          </CardHeader>
            ...
            <div className="flex items-center gap-2">
              {FUNNEL_PAGES.map((page, i) => (
                <React.Fragment key={page.type}>
                  <Badge
                    variant={page.color === "orange" ? "default" : page.color}
                  >
                    {page.label}
                  </Badge>
  ...
  return (
    <div className={cn("space-y-6", className)}>
      ...
      {/* ─── Preview Mode ─── */}
      {viewMode === "preview" && <FunnelPreview funnelData={funnelData} />}
                ...
                {isEditing ? (
                  <div className="space-y-3">
                    <input
                      ...
                      onChange={(e) =>
                        updatePageField("optin", "headline", e.target.value)
                      }
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        updatePageField("optin", "subheadline", e.target.value)
                      }
