  ...
  return (
    <div className="grid grid-cols-3 gap-4 mb-6">
      {[
        ...
        { icon: Medal, label: "2eme", desc: "En progression", color: "text-gray-300", bg: "bg-gray-300/10" },
        { icon: Star, label: "3eme", desc: "Challenger", color: "text-orange-400", bg: "bg-orange-400/10" },
      ].map((item) => (
...
export default function LeaderboardPage() {
  return (
    <div>
      <PageHeader
        title="Classement"
        description="Classement de la communaute ScalingFlow."
      />
      <LeaderboardHeader />
