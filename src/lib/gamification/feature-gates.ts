...
export const FEATURE_GATES: FeatureGate[] = [
  // Niveau 0 — accessible immédiatement
  {
    ...
    label: "Onboarding",
    requiredLevel: 0,
    description: "Parcours d'onboarding complet",
  },
  {
    feature: "market",
    label: "Analyse de marché",
    requiredLevel: 0,
    description: "Analyse et validation de ton marché",
  },
  {
    feature: "offer",
    label: "Offre",
    requiredLevel: 0,
    description: "Création et packaging de ton offre",
  },
  {
    feature: "vault",
    label: "Vault",
    requiredLevel: 0,
    description: "Ton coffre-fort d'expertise",
  },
  {
    feature: "brand",
    label: "Marque",
  ...
  // Niveau 1
  {
    ...
    label: "Funnel",
    requiredLevel: 1,
    description: "Construction de ton funnel de vente",
  },
  {
    feature: "assets",
    label: "Assets de vente",
    requiredLevel: 1,
    description: "VSL, emails, lettres de vente",
  },
  ...
  // Niveau 2
  {
    ...
    label: "Publicités",
    requiredLevel: 2,
    description: "Création et gestion de campagnes ads",
  },
  {
    feature: "content",
    label: "Contenu",
    requiredLevel: 2,
    description: "Stratégie et génération de contenu",
  },
  {
    feature: "prospection",
    label: "Prospection",
    requiredLevel: 2,
    description: "Scripts et stratégies de prospection",
  },
  {
    feature: "sales",
    label: "Vente",
    requiredLevel: 2,
    description: "Outils et scripts de vente",
  },
  ...
  // Niveau 3
  {
    ...
    label: "Lancement",
    requiredLevel: 3,
    description: "Pipeline et lancement de produit",
  },
  {
    feature: "analytics",
    label: "Analytics",
    requiredLevel: 3,
    description: "Analyse de performance avancée",
  },

  // Niveau 4
  {
    feature: "portal",
    label: "Portail Whitelabel",
    requiredLevel: 4,
    description: "Espace brandé pour tes clients",
  },
];
