...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Marche", href: "/market", icon: Globe, roles: ["user", "student", "admin", "coach"] },
  ...
  { label: "Communaute", href: "/community", icon: Users, roles: ["user", "student", "admin", "coach"] },
  { label: "Activite", href: "/activity-log", icon: Activity, roles: ["user", "student", "admin", "coach"] },
...
export const QUICK_LINKS = [
  ...
  { label: "Activite", href: "/activity-log", icon: Activity },
